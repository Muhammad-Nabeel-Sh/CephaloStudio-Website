        ...
        return (
          <div key={sec.id}>
            ...
            {!isCollapsed && items.map(m => {
              ...
              const filteredMeas = Object.entries(meas).filter(([k]) => m.type === "point" || (k !== "x" && k !== "y")); const ms = filteredMeas.map(([k, v]) => k === "angle" ? formatAngle(v) : v.toFixed(1) + (k === "area" ? " mm²" : " mm")).join("  ");
