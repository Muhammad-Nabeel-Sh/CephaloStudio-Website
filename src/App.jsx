...
function Workspace({project,onUpdateProject,onHome,t,theme,setTheme,onSave,onImport}){
  ...
  const handleMouseMove=useCallback(e=>{
    ...
    const _hp=hoveredPtRef.current;canvasRef.current.style.cursor=(_hp&&(_hp.type==="bezierCp"||_hp.type==="bezier"||_hp.type==="path"||_hp.type==="point"||_hp.type==="tangent"||_hp.type==="silhouette"||_hp.type==="rotate"||_hp.type==="corner"))?"pointer":"";
  ...
  },[activeTool,markups,zoom,snapEnabled,selectedId,updMarkup,updMarkups,toImage,getCanvasPos,currentDraw?.type,syncTangents]);
