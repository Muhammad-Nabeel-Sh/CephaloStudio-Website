...
export const STUDY_TYPES = [
  ...
  { id: "airway", name: "Airway Analysis",
  icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M10.5 2v6.917a1.5 1.5 0 0 1-.971 1.55m3.942-8.467v6.917a1.5 1.5 0 0 0 .971 1.55m-.971-8.467L14.47 10.47M9.53 10.47l-.084-1.665c-.036-.704-.3-1.437-.965-1.672-1.145-.406-3.009-.133-5.188 2.687-2.026 2.62-2.416 6.742-2.262 9.846.088 1.785 1.9 2.776 3.577 2.156l3.327-1.23c1.23-.455 2.022-1.655 1.956-2.965l-.177-3.518m3.576 3.518-1.772-.886a1.05 1.05 0 0 0-1.033 0l-1.771.886m3.576 0 .177 3.518c.066 1.31-.726 2.51-1.956 2.965l-3.327 1.23c-1.677.62-3.488-.37-3.577-2.156-.153-3.104.237-7.226 2.262-9.846 2.18-2.82 4.044-3.093 5.189-2.687.664.235.929.969.965 1.672l.083 1.665"/>',
  desc: "Pharyngeal airway measurements, norms, z-scores", color: "#38bdf8", needsGroups: false },
];
